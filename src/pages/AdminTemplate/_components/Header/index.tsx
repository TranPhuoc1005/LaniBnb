        ...
        <div className="fixed z-9 top-0 inset-x-0 h-15 md:h-20 shadow-2xs md:pl-70 md:group-[.menuSmall]:pl-20 transition-all duration-300 bg-white">
            <div className="flex justify-between items-center px-3 md:px-5 lg:px-10 h-full">
                <div className="hidden md:block">
                    <button
                        className={` btn-hamburger hamburger hamburger--squeeze ${
                ...
                <div className="relative" ref={avatarRef}>
                    ...
                    {isActiveAvatar && (
                        <div className="absolute top-[120%] overflow-hidden right-0 z-10 bg-white divide-y divide-gray-200 rounded-md shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
                            <p>
                                <Link to={"/"} className="block cursor-pointer px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                    Về trang chủ
                                </Link>
                            </p>
                            <p
                                onClick={handleLogout}
                                className="cursor-pointer px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
                            >
                                Đăng xuất
                            </p>
                        </div>
