...
export default function Header() {
    ...
    // Auth store
    const { user, isAuthenticated, signOut } = userAuthStore();
    ...
    const menuItems: MenuItem[] = [
        ...
        },
        {
            ...
            content: {
                ...
                description: "Kết nối với chúng tôi để được tư vấn và hỗ trợ tốt nhất",
                features: [
        ...
        <>
            <header className="glass-effect bg-white/90 shadow-md fixed left-0 right-0 top-0 z-101">
                <div className="max-w-6xl mx-auto flex justify-between items-center py-2 px-5">
                    ...
                    <nav ref={navRef} className="md:flex hidden space-x-1 lg:space-x-4 lg:space-x-1 relative">
                        {activeItem && (
                            <div 
                        ...
                        {menuItems.map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className={`min-w-[90px] lg:min-w-[105px] flex flex-col items-center justify-center px-2 lg:px-4 py-1 rounded-lg transition-all duration-200 relative z-10 ${
                                        isActive
                                            ? "text-white"
                        ...
                        {isAuthenticated && user && (
                            <div className="relative -top-1" ref={dropdownRef}>
                                <button
                                    ...
                                    className="min-w-[90px] lg:min-w-[105px] flex flex-col items-center px-2 lg:px-4 py-1 rounded-lg transition-all duration-200 text-gray-700 hover:text-sky-300 focus:outline-none"
                                >
                                    ...
                                    <span className="font-medium text-sm lg:text-base truncate max-w-[80px] lg:max-w-[90px] leading-4">
                                        {user.name}
                                    </span>
                                </button>
